...
\begin{center}
\noindent\textcolor{Green}{\syntax{[\{\textcolor{Black}{\textbf{big}}\}/\{\textcolor{Black}{\textbf{small}}\}]}\textcolor{Black}{\textbf{ast}} }\end{center}

Имеются логические типы конкретных размеров, а именно, типы \textbf{ast1}, \textbf{ast3},
\textbf{ast5}, \textbf{ast7}, переменные которых имеют размер в 1, 2, 4 и 8 байт соответственно.
...
\textcolor{Green}{%
\syntax{%
\synt{описание_функции}$\to$[\textcolor{Black}{\textbf{головная}}|\textcolor{Black}{\textbf{чистая}}] \textcolor{Black}{\textbf{функция}} \synt{имя_функции} %
...
Необязательное ключевое слово \textbf{головной} означает, что выполнение модуля начинается с этой функции. Функций с атрибутом \textbf{головной} в модуле может быть не более одной.
...
\begin{center}
\textcolor{Green}{\syntax{(\textcolor{Black}{\texttt{+|}}\synt{имя_цикла}\textcolor{Black}{\texttt{:}})%
\textcolor{Black}{\textbf{вечно}} \textcolor{Black}{\textbf{повторяй}}\textcolor{Black}{\texttt{\{}} \{\synt{описание}|\synt{операторы}\} \textcolor{Black}{\texttt{\}}} }}
\end{center}
...
Оператор возврата из подпрограммы совершает выход из функции. Если тип возвращаемого функцией значения --- тип \textbf{ничто}, то выход из подпрограммы выполняется
с помощью оператора возврата, имеющего вид \textbf{возврат}. Если же тип возвращаемого функцией значения не эквивалентен типу \textbf{ничто}, то возврат выполняется
