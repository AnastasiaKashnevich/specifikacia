...
\begin{center}
\noindent\textbf{type} \textcolor{Green}{\syntax{\synt{имя_типа}\textcolor{Black}{\texttt{-}}%
...
\noindent\textcolor{Black}{\textbf{delete}}\textcolor{Black}{\texttt{[}}\synt{имя массива/имя переменной}\textcolor{Black}{\texttt{]}}%\\
\\
%\\
\\ %
}}
...
\subsection{Oператор времени time}
Синтаксис оператора вычисления времени работы программы time:
\begin{center}
\noindent\textcolor{Green}{\syntax{%
\noindent\textcolor{Black}{\textbf{time}}\textcolor{Black}{\texttt{[}}\synt{имя программы}\textcolor{Black}{\texttt{]}}%\\
\\
%\\
\\ %
}}
